...
public abstract class TestWriter<S extends TestSource, T extends TestTarget>
  ...
  protected void writeProlog( T target, String testName, IndentedWriter targetWriter)
    {
    writeDocstring(target, testName, targetWriter);
  ...
  */
  protected void writeDocstring( T target, String testName, IndentedWriter targetWriter)
  {
    targetWriter.println("/**");
    targetWriter.println(" * Generated by tcases");
    targetWriter.println(" * Do not edit manually");
    targetWriter.println(" */");
  };
